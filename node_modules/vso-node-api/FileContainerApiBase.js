...
var FileContainerApiBase = (function (_super) {
    ...
    */
    FileContainerApiBase.prototype.createItems = function (items, containerId, scope) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, Container) {
            if (err) {
    ...
    * @param {string} scope - A guid representing the scope of the container. This is often the project id.
    */
    FileContainerApiBase.prototype.deleteItem = function (containerId, itemPath, scope) {
        var _this = this;
        var deferred = Q.defer();
    ...
    */
    FileContainerApiBase.prototype.getContainers = function (scope, artifactUris) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, Containers) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    */
    FileContainerApiBase.prototype.getItems = function (containerId, scope, itemPath, metadata, format, downloadFileName, includeDownloadTickets, isShallow) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, Containers) {
            if (err) {
    ...
    */
    FileContainerApiBase.prototype.browseItems = function (container, itemPath) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, Containers) {
            if (err) {
