...
var WorkItemTrackingApi = (function (_super) {
    ...
    */
    WorkItemTrackingApi.prototype.createAttachment = function (customHeaders, contentStream, fileName, uploadType) {
        var _this = this;
    ...
    * @param {string} fileName
    */
    WorkItemTrackingApi.prototype.getAttachmentContent = function (id, fileName) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, attachment) {
            if (err) {
    ...
    * @param {string} fileName
    */
    WorkItemTrackingApi.prototype.getAttachmentZip = function (id, fileName) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, attachment) {
            if (err) {
    ...
    * @param {number} depth
    */
    WorkItemTrackingApi.prototype.getRootNodes = function (project, depth) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, classificationNodes) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} path
    */
    WorkItemTrackingApi.prototype.createOrUpdateClassificationNode = function (postedNode, project, structureGroup, path) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, classificationNode) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    */
    WorkItemTrackingApi.prototype.deleteClassificationNode = function (project, structureGroup, path, reclassifyId) {
        var _this = this;
        var deferred = Q.defer();
    ...
    * @param {number} depth
    */
    WorkItemTrackingApi.prototype.getClassificationNode = function (project, structureGroup, path, depth) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, classificationNode) {
            if (err) {
    ...
    * @param {string} path
    */
    WorkItemTrackingApi.prototype.updateClassificationNode = function (postedNode, project, structureGroup, path) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, classificationNode) {
            if (err) {
    ...
    */
    WorkItemTrackingApi.prototype.getComment = function (id, revision) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, comment) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    */
    WorkItemTrackingApi.prototype.getComments = function (id, fromRevision, top, order) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, comment) {
            if (err) {
    ...
    */
    WorkItemTrackingApi.prototype.getField = function (field) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, field) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    */
    WorkItemTrackingApi.prototype.getFields = function (expand) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, fields) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} skip
    */
    WorkItemTrackingApi.prototype.getHistory = function (id, top, skip) {
        var _this = this;
        var deferred = Q.defer();
    ...
    */
    WorkItemTrackingApi.prototype.getHistoryById = function (id, revisionNumber) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, history) {
            if (err) {
    ...
    */
    WorkItemTrackingApi.prototype.createQuery = function (postedQuery, project, query) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, querie) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} query
    */
    WorkItemTrackingApi.prototype.deleteQuery = function (project, query) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode) {
            if (err) {
    ...
    */
    WorkItemTrackingApi.prototype.getQueries = function (project, expand, depth, includeDeleted) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, queries) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {boolean} includeDeleted
    */
    WorkItemTrackingApi.prototype.getQuery = function (project, query, expand, depth, includeDeleted) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, querie) {
            if (err) {
    ...
    */
    WorkItemTrackingApi.prototype.updateQuery = function (queryUpdate, project, query, undeleteDescendants) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, querie) {
            if (err) {
    ...
    * @param {string} project - Project ID or project name
    */
    WorkItemTrackingApi.prototype.destroyWorkItem = function (id, project) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode) {
            if (err) {
    ...
    * @param {string} project - Project ID or project name
    */
    WorkItemTrackingApi.prototype.getDeletedWorkItem = function (id, project) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, recyclebin) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number[]} ids
    */
    WorkItemTrackingApi.prototype.getDeletedWorkItems = function (project, ids) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, recyclebin) {
            if (err) {
    ...
    * @param {string} project - Project ID or project name
    */
    WorkItemTrackingApi.prototype.restoreWorkItem = function (payload, id, project) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, recyclebin) {
            if (err) {
    ...
    */
    WorkItemTrackingApi.prototype.getRevision = function (id, revisionNumber, expand) {
        var _this = this;
        var deferred = Q.defer();
    ...
    * @param {WorkItemTrackingInterfaces.WorkItemExpand} expand
    */
    WorkItemTrackingApi.prototype.getRevisions = function (id, top, skip, expand) {
        var _this = this;
        var deferred = Q.defer();
    ...
    */
    WorkItemTrackingApi.prototype.evaluateRulesOnField = function (ruleEngineInput) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode) {
            if (err) {
    ...
    */
    WorkItemTrackingApi.prototype.createTemplate = function (template, teamContext) {
        var _this = this;
        var deferred = Q.defer();
    ...
    */
    WorkItemTrackingApi.prototype.getTemplates = function (teamContext, workitemtypename) {
        var _this = this;
        var deferred = Q.defer();
    ...
    */
    WorkItemTrackingApi.prototype.deleteTemplate = function (teamContext, templateId) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode) {
            if (err) {
    ...
    * @param {string} templateId - Template Id
    */
    WorkItemTrackingApi.prototype.getTemplate = function (teamContext, templateId) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, template) {
            if (err) {
    ...
    * @param {string} templateId - Template id
    */
    WorkItemTrackingApi.prototype.replaceTemplate = function (templateContent, teamContext, templateId) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, template) {
            if (err) {
        ...
        this.vsoClient.getVersioningData("3.0-preview.1", "wit", "fb10264a-8836-48a0-8033-1b0ccd2748d5", routeValues)
            ...
            var apiVersion = versioningData.apiVersion;
            var serializationData = { responseIsCollection: false };
            _this.restClient.replace(url, apiVersion, templateContent, null, serializationData, onResult);
        })
            .fail(function (error) {
            onResult(error, error.statusCode, null);
        });
    ...
    */
    WorkItemTrackingApi.prototype.getUpdate = function (id, updateNumber) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, update) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} skip
    */
    WorkItemTrackingApi.prototype.getUpdates = function (id, top, skip) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, updates) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} top
    */
    WorkItemTrackingApi.prototype.queryByWiql = function (wiql, teamContext, timePrecision, top) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, wiql) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {boolean} timePrecision
    */
    WorkItemTrackingApi.prototype.queryById = function (id, teamContext, timePrecision) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, wiql) {
            if (err) {
    ...
    */
    WorkItemTrackingApi.prototype.getReportingLinks = function (project, types, continuationToken, startDateTime) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemLink) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    */
    WorkItemTrackingApi.prototype.getRelationType = function (relation) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemRelationType) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    /**
    */
    WorkItemTrackingApi.prototype.getRelationTypes = function () {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemRelationTypes) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    */
    WorkItemTrackingApi.prototype.readReportingRevisionsGet = function (project, fields, types, continuationToken, startDateTime, includeIdentityRef, includeDeleted, includeTagRef, includeLatestOnly, expand) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemRevision) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {WorkItemTrackingInterfaces.ReportingRevisionsExpand} expand
    */
    WorkItemTrackingApi.prototype.readReportingRevisionsPost = function (filter, project, continuationToken, startDateTime, expand) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemRevision) {
            if (err) {
    ...
    */
    WorkItemTrackingApi.prototype.deleteWorkItem = function (id, destroy) {
        var _this = this;
        var deferred = Q.defer();
    ...
    * @param {WorkItemTrackingInterfaces.WorkItemExpand} expand
    */
    WorkItemTrackingApi.prototype.getWorkItem = function (id, fields, asOf, expand) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItem) {
            if (err) {
    ...
    * @param {WorkItemTrackingInterfaces.WorkItemExpand} expand
    */
    WorkItemTrackingApi.prototype.getWorkItems = function (ids, fields, asOf, expand) {
        var _this = this;
        var deferred = Q.defer();
    ...
    */
    WorkItemTrackingApi.prototype.updateWorkItem = function (customHeaders, document, id, validateOnly, bypassRules) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItem) {
            if (err) {
    ...
    * @param {boolean} bypassRules
    */
    WorkItemTrackingApi.prototype.createWorkItem = function (customHeaders, document, project, type, validateOnly, bypassRules) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItem) {
            if (err) {
    ...
    * @param {WorkItemTrackingInterfaces.WorkItemExpand} expand
    */
    WorkItemTrackingApi.prototype.getWorkItemTemplate = function (project, type, fields, asOf, expand) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItem) {
            if (err) {
    ...
    * @param {string} project - Project ID or project name
    */
    WorkItemTrackingApi.prototype.getWorkItemTypeCategories = function (project) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemTypeCategories) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    */
    WorkItemTrackingApi.prototype.getWorkItemTypeCategory = function (project, category) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemTypeCategorie) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} type
    */
    WorkItemTrackingApi.prototype.getWorkItemType = function (project, type) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemType) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} project - Project ID or project name
    */
    WorkItemTrackingApi.prototype.getWorkItemTypes = function (project) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemTypes) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} field
    */
    WorkItemTrackingApi.prototype.getDependentFields = function (project, type, field) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemTypesField) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    */
    WorkItemTrackingApi.prototype.exportWorkItemTypeDefinition = function (project, type, exportGlobalLists) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemTypeTemplate) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} project - Project ID or project name
    */
    WorkItemTrackingApi.prototype.updateWorkItemTypeDefinition = function (updateModel, project) {
        var _this = this;
        var deferred = Q.defer();
        var onResult = function (err, statusCode, workItemTypeTemplate) {
            if (err) {
